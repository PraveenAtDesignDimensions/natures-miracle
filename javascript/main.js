(function ($) {
            ...
            $(this).gmap3({
              marker: {
                ...
                options: {
                  visible: false,
                  icon:
                    "http://themesflat.com/html/arch/images/icon/marker.png",
                },
              },
            });
          },
  ...
  var productSlide = function () {
    $(".flat-product-single-slider").each(function () {
      $(this)
        .children("#flat-product-carousel")
        .flexslider({
          animation: "slide",
          controlNav: false,
          animationLoop: false,
      ...
      $(this)
        .children("#flat-product-flexslider")
        .flexslider({
          animation: "slide",
          controlNav: false,
          animationLoop: false,
...
//  home delivery prompt
document
  .getElementById("home_delivery")
  .addEventListener("click", goToLeMarche);
